...
export const headers = ['Date', 'Product', 'Sales', 'Product Type', 'Price', 'Status'];
...
export const headersSales = ['Date', 'Product', 'Customer ID', 'Product Type',  'Your Profit', 'sales', 'Price', 'Options'];

export const dataSales: Row[] = [
...
export const headerPurchase = ['Date', 'Product', 'merchant', 'Product Type', 'Price', 'Status'];
