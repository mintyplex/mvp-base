...
const Accordium: React.FC<AccordiumProps> = ({ title, children }: AccordiumProps) => {
  ...
  return (
    <div className='bg-[rgb(49,50,51)] px-4 py-3 mt-6 rounded-md ' >
      ...
      >
        ...
        {isAccordionOpen ? <p><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
  <path stroke-linecap="round" stroke-linejoin="round" d="m4.5 15.75 7.5-7.5 7.5 7.5" />
</svg>
</p> : <p><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
